# Dossier de presse — Arnisound Tools

*Contact presse : contact@arnisoundtools.com · arnisoundtools.com*

---

## En bref (boilerplate)

**Arnisound Tools** est une suite d'outils web pour les métiers du spectacle
vivant, de l'audiovisuel et de l'événementiel : son, lumière, vidéo et régie.
...
> Les outils du terrain, par des gens du terrain : des applications web simples et
> en français pour le son, la lumière, la vidéo et la régie.
...
- **Fondateur :** Théo Arnissolle, technicien du spectacle
- **Basé en France** (Castelnau-le-Lez, région de Montpellier)
- **Lancement :** 2026
- **Modèle :** paiement unique, **licence perpétuelle**, sans abonnement
- **Accès :** 100 % web, aucune installation, en français
- **AV Calc :** 71 outils répartis en 8 catégories
- **RF Shot :** coordonne plus de 100 fréquences, intermodulations jusqu'à l'ordre 7
...
## Ce qui rend Arnisound différent

- **Fait par un homme de terrain**, pas par un éditeur déconnecté.
- **En français**, avec le contexte réglementaire local (ARCOM/ANFR, TNT/PMSE).
- **Accessible** : prix pensés pour les intermittents et prestataires régionaux,
  paiement unique, rien à installer.
- **Efficace** : trois infos, un résultat. Zéro superflu.

---

## Angles pour la presse (idées de sujets)

- Un technicien du spectacle qui code ses propres outils pour la profession.
- Comment éviter les micros HF qui grésillent / décrochent en plein show.
- Des alternatives françaises et abordables aux logiciels pros hors de prix.
- L'outillage numérique du régisseur en 2026 : faire mieux avec son navigateur.
- Entreprendre en solo dans une niche technique (spectacle / événementiel).

---

## Visuels & ressources

Disponibles sur demande (haute résolution) :
- Logo Arnisound Tools (SVG / PNG, fond clair et sombre)
- Logos produits (Speed RF, RF Shot, AV Calc, Fiche Tech, Repérages)
- Captures d'écran des outils
- Vidéo motion (logo animé) + visuels de lancement

→ Demande à **contact@arnisoundtools.com**

---

## Informations pratiques

- **Marque :** Arnisound Tools
- **Fondateur :** Théo Arnissolle
- **Statut :** entreprise individuelle (micro-entreprise), France
- **Site :** https://arnisoundtools.com
- **Contact presse :** contact@arnisoundtools.com
- **Réseaux :** Instagram & Facebook (@arnisoundtools)

---

## Modèle d'e-mail de prise de contact presse

> **Objet :** Un technicien du spectacle lance ses propres outils pour la profession
>
> Bonjour [Prénom],
>
> Je m'appelle Théo Arnissolle, je suis technicien du spectacle. J'ai lancé
> **Arnisound Tools**, une suite d'outils web simples et en français pour le son,
> la lumière, la vidéo et la régie — dont des outils de coordination de fréquences
> pour micros sans fil qui évitent les grésillements et décrochages en plein show.
>
> L'idée : rendre accessibles des outils d'ordinaire chers, complexes et en anglais,
> à tous les techniciens et prestataires. Deux outils sont même gratuits.
>
> Je me disais que ça pourrait intéresser vos lecteurs de [média]. Je vous joins un
> dossier de presse et des visuels, et je reste dispo pour un échange ou une démo.
>
> Bien à vous,
> Théo Arnissolle — arnisoundtools.com — contact@arnisoundtools.com
