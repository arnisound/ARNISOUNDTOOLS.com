...
> essentiels, mais **vérifiez toujours l'état à jour auprès de l'ANFR et de l'ARCEP**
> avant un événement (voir sources en bas).

---

## D'abord, comprendre le système

Le spectre radio est une ressource **publique et limitée**. En France, c'est l'**Agence
nationale des fréquences (ANFR)** qui le planifie et le répartit entre tous les usages
(télévision, mobile, aéronautique… et micros sans fil) [1].
...
- Un matériel HF **ancien** réglé dans cette bande va **brouiller et être brouillé**.
- Son usage y est désormais **illégal**.

Sur un vieux système, le premier réflexe consiste à **vérifier sa plage de fréquences**
avant de l'utiliser.
...
**autorisations temporaires** ouvrant des bandes supplémentaires. Pour les **Jeux de
Paris 2024**, par exemple, des bandes comme 1240–1260 MHz et 1350–1400 MHz ont été
temporairement ouvertes pour la PMSE [4]. Ce sont des cas encadrés, hors usage courant.

---

## En pratique : comment choisir ses fréquences

1. **Rester dans les bandes autorisées** (UHF 470–694, 823–832, 1785–1805).
2. **Éviter la TNT locale** : repérer les canaux TV occupés dans la ville de
   l'événement.
...
évitent la TNT française. Pour les grosses configs,
