...
## Fiche technique ou rider : quelle différence ?
...
### 2. Le plateau
- **Dimensions** minimales (ouverture, profondeur, hauteur sous perches)
- Sol, pendrillonnage, fond de scène
- **Décor** apporté, contraintes de montage
- **Accès** (largeur des portes, quai de déchargement, monte-charge)
- Contraintes de **sécurité** (accroche, charges, dégagements) [3]

### 3. Le son
- Système de diffusion souhaité (façade, retours / ears)
- **Patch** (liste des entrées : instruments, micros, DI…)
- Micros et pieds nécessaires
- Nombre et type de **retours**
- Console souhaitée, position de la régie
- Besoins en **fréquences HF** (micros/ears sans fil)

### 4. La lumière
- Type et nombre de **projecteurs**, ambiances
- **Plan de feu** / implantation
- Console lumière, gradateurs, puissance disponible
- Effets particuliers (machine à fumée, etc.)

### 5. La vidéo (si besoin)
- Vidéoprojecteur / mur LED, écran, résolution
- Sources, régie vidéo, câblage

### 6. L'électricité
- Puissance nécessaire (par poste), type de raccordement
- Arrivées et emplacements
...
### 8. Annexes
- **Plans** (implantation, plan de feu, patch)
- Photos du décor
- Contacts
...
- **Un PDF propre**, pas un Word déformé à l'ouverture.
...
- Le secret : **précise, réaliste, datée, avec un contact clair et de bons plans**.
