...
mais il existe aussi des produits d'ordre 5, 7… plus faibles mais bien réels, dont il
faut tenir compte dès qu'on empile beaucoup d'émetteurs. Certains produits impliquent
même **3 émetteurs** (par exemple f1 + f2 − f3).
